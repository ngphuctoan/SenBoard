...
fun Modifier.senBoardCombinedClickable(
    ...
    return pointerInput(
        ...
        awaitEachGesture {
            ...
            if (uptimeMillisChanged && doubleTapBeforeTimeout) {
                onDoubleTap()
...
sealed interface SelectedIndexResult {
    ...
    data class Selected(val index: Int) : SelectedIndexResult
}
...
@Composable
fun SenBoardPreview() {
    var preferences by remember { mutableStateOf(SenPreferences(showKeyBackground = true)) }
